...
require_once 'logic/add_teacher.logic.php';
?>
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <title>เพิ่มข้อมูลอาจารย์ - SKR Attendance</title>
    ...
    <nav class="bg-gradient-to-r from-blue-700 to-blue-600 text-white px-4 py-3 shadow-lg sticky top-0 z-50">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
            ...
            <ul id="mobile-menu" class="hidden md:flex space-x-1 md:space-x-2 lg:space-x-4 text-sm md:text-base mt-4 md:mt-0 flex-col md:flex-row w-full md:w-auto bg-blue-700 md:bg-transparent p-2 md:p-0 rounded-lg">
                ...
                <li><a href="add_teacher.php" class="flex items-center px-3 py-2 rounded bg-blue-800 md:bg-blue-500/20 font-bold "><i class="fas fa-chalkboard-user mr-2 w-5 text-center"></i>เพิ่มอาจารย์</a></li>
    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 mb-8">
            <h2 class="text-2xl font-bold text-gray-800 mb-6 flex items-center">
                ...
                <span>อัปโหลดข้อมูลอาจารย์ด้วย Excel</span>
            </h2>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
                ...
                <ul class="text-blue-700 space-y-2 text-sm">
                    ...
                    <li class="flex items-start">
                        <i class="fas fa-check-circle mr-2 mt-1 text-green-500"></i>
                        <span>ต้องมีคอลัมน์ตามลำดับ: รหัสอาจารย์, ปีการศึกษา, คำนำหน้า, ชื่อ, นามสกุล, ห้องเรียน, กลุ่มสาระ/กลุ่มวิชา, เลขบัตรประชาชน</span>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle mr-2 mt-1 text-green-500"></i>
            ...
            <form action="#" method="post" enctype="multipart/form-data" id="excel-upload-form" class="space-y-6">
                ...
                <div class="flex flex-col md:flex-row gap-4 items-center">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="download_teacher_template.php" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center shadow-md hover:shadow-lg">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <form action="#" method="post" id="multi-teacher-form" class="space-y-6">
                <input type="hidden" name="multi_teacher" value="1">

                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">รหัสอาจารย์</th>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">กลุ่มสาระ/กลุ่มวิชา</th>
                        ...
                        <tbody id="teacher-rows" class="bg-white divide-y divide-gray-200">
                            <tr class="teacher-row hover:bg-gray-50 transition-colors duration-150">
                                <td class="px-4 py-3 whitespace-nowrap" data-label="รหัสอาจารย์">
                                    <div class="relative">
                                        <input type="text" name="teacher_id[]" required
                                            ...
                                            placeholder=" " aria-label="รหัสอาจารย์">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap" data-label="กลุ่มสาระ/กลุ่มวิชา">
                                    <div class="relative">
                                        <input type="text" name="subject_group[]" required
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 peer"
                                            placeholder=" " aria-label="กลุ่มสาระ/กลุ่มวิชา">
                                        <label class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none transition-all duration-200 
                                             peer-focus:text-xs peer-focus:-top-2 peer-focus:bg-white peer-focus:px-1 peer-focus:text-blue-600
                                             peer-placeholder-shown:text-base peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2">
                                            เช่น คณิตศาสตร์
                                ...
                                <td class="px-4 py-3 whitespace-nowrap" data-label="เลขบัตรประชาชน">
                                    <div class="relative">
                                        <input type="text" name="teacher_citizen_id[]" required pattern="[0-9]{13}" maxlength="13" minlength="13"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 peer"
